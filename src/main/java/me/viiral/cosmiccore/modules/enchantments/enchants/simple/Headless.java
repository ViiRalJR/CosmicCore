...
public class Headless extends WeaponDeathEventEnchant {

    public Headless() {
        super("Headless", EnchantTier.SIMPLE, 3, EnchantType.SWORD, "Victims have a chance of dropping their head on death.");
    }
