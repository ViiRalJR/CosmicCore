...
public class MaskHelmetBuilder {
    ...
    public boolean hasMask() {
        if (this.cosmicData.hasTag("maskType")) {
            return this.cosmicData.getString("maskType") != null && !this.cosmicData.getString("maskType").equals("null");
        }
        return false;
    }
    ...
    public MaskHelmetBuilder removeMask() {
        ...
        item.getOrCreateCompound("cosmicData").removeKey("maskType");
        this.nbtItem = item;
        return this;
    }
